...
public  final class GetNetworkIDRequest extends
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetNetworkIDRequest)) {
  ...
  public static GetNetworkIDRequest parseFrom(
  ...
  public static GetNetworkIDRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetNetworkIDRequest parseFrom(
  ...
  public static GetNetworkIDRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetNetworkIDRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetNetworkIDRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetNetworkIDRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public GetNetworkIDRequest getDefaultInstanceForType() {
      return GetNetworkIDRequest.getDefaultInstance();
    }

    public GetNetworkIDRequest build() {
      GetNetworkIDRequest result = buildPartial();
    ...
    public GetNetworkIDRequest buildPartial() {
      GetNetworkIDRequest result = new GetNetworkIDRequest(this);
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetNetworkIDRequest) {
        return mergeFrom((GetNetworkIDRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetNetworkIDRequest other) {
      if (other == GetNetworkIDRequest.getDefaultInstance()) return this;
      onChanged();
      return this;
    }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetNetworkIDRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetNetworkIDRequest) e.getUnfinishedMessage();
  ...
  private static final GetNetworkIDRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetNetworkIDRequest();
  }

  public static GetNetworkIDRequest getDefaultInstance() {
