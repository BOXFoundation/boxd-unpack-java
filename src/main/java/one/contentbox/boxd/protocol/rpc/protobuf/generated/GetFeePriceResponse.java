...
public  final class GetFeePriceResponse extends
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof GetFeePriceResponse)) {
      return super.equals(obj);
    }
    GetFeePriceResponse other = (GetFeePriceResponse) obj;
  ...
  public static GetFeePriceResponse parseFrom(
  ...
  public static GetFeePriceResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetFeePriceResponse parseFrom(
  ...
  public static GetFeePriceResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetFeePriceResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetFeePriceResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetFeePriceResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public GetFeePriceResponse getDefaultInstanceForType() {
      return GetFeePriceResponse.getDefaultInstance();
    }

    public GetFeePriceResponse build() {
      GetFeePriceResponse result = buildPartial();
    ...
    public GetFeePriceResponse buildPartial() {
      GetFeePriceResponse result = new GetFeePriceResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetFeePriceResponse) {
        return mergeFrom((GetFeePriceResponse)other);
      } else {
    ...
    public Builder mergeFrom(GetFeePriceResponse other) {
      if (other == GetFeePriceResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetFeePriceResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetFeePriceResponse) e.getUnfinishedMessage();
  ...
  private static final GetFeePriceResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetFeePriceResponse();
  }

  public static GetFeePriceResponse getDefaultInstance() {
