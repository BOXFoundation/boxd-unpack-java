...
public  final class FetchUtxosResp extends
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return TransactionProto.internal_static_rpcpb_FetchUtxosResp_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            FetchUtxosResp.class, FetchUtxosResp.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof FetchUtxosResp)) {
      return super.equals(obj);
    }
    FetchUtxosResp other = (FetchUtxosResp) obj;
  ...
  public static FetchUtxosResp parseFrom(
  ...
  public static FetchUtxosResp parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static FetchUtxosResp parseFrom(
  ...
  public static FetchUtxosResp parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static FetchUtxosResp parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static FetchUtxosResp parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(FetchUtxosResp prototype) {
  ...
  public static final class Builder extends
    ...
    public FetchUtxosResp getDefaultInstanceForType() {
      return FetchUtxosResp.getDefaultInstance();
    }

    public FetchUtxosResp build() {
      FetchUtxosResp result = buildPartial();
    ...
    public FetchUtxosResp buildPartial() {
      FetchUtxosResp result = new FetchUtxosResp(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof FetchUtxosResp) {
        return mergeFrom((FetchUtxosResp)other);
      } else {
    ...
    public Builder mergeFrom(FetchUtxosResp other) {
      if (other == FetchUtxosResp.getDefaultInstance()) return this;
      if (other.getCode() != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      FetchUtxosResp parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (FetchUtxosResp) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder addAllUtxos(
        java.lang.Iterable<? extends Utxo> values) {
      if (utxosBuilder_ == null) {
        ensureUtxosIsMutable();
  ...
  private static final FetchUtxosResp DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new FetchUtxosResp();
  }

  public static FetchUtxosResp getDefaultInstance() {
