...
public  final class GetRawTransactionRequest extends
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetRawTransactionRequest)) {
      return super.equals(obj);
    }
    GetRawTransactionRequest other = (GetRawTransactionRequest) obj;
  ...
  public static GetRawTransactionRequest parseFrom(
  ...
  public static GetRawTransactionRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetRawTransactionRequest parseFrom(
  ...
  public static GetRawTransactionRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetRawTransactionRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetRawTransactionRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetRawTransactionRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public GetRawTransactionRequest getDefaultInstanceForType() {
      return GetRawTransactionRequest.getDefaultInstance();
    }

    public GetRawTransactionRequest build() {
      GetRawTransactionRequest result = buildPartial();
    ...
    public GetRawTransactionRequest buildPartial() {
      GetRawTransactionRequest result = new GetRawTransactionRequest(this);
      result.hash_ = hash_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetRawTransactionRequest) {
        return mergeFrom((GetRawTransactionRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetRawTransactionRequest other) {
      if (other == GetRawTransactionRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetRawTransactionRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetRawTransactionRequest) e.getUnfinishedMessage();
  ...
  private static final GetRawTransactionRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetRawTransactionRequest();
  }

  public static GetRawTransactionRequest getDefaultInstance() {
