...
public  final class GetBlockRequest extends
  ...
  public static GetBlockRequest parseFrom(
  ...
  public static GetBlockRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetBlockRequest parseFrom(
  ...
  public static GetBlockRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetBlockRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetBlockRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetBlockRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public GetBlockRequest getDefaultInstanceForType() {
      return GetBlockRequest.getDefaultInstance();
    }

    public GetBlockRequest build() {
      GetBlockRequest result = buildPartial();
    ...
    public GetBlockRequest buildPartial() {
      GetBlockRequest result = new GetBlockRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetBlockRequest) {
        return mergeFrom((GetBlockRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetBlockRequest other) {
      if (other == GetBlockRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetBlockRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetBlockRequest) e.getUnfinishedMessage();
  ...
  private static final GetBlockRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetBlockRequest();
  }

  public static GetBlockRequest getDefaultInstance() {
