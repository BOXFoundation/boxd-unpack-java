...
public  final class SplitContractInfo extends
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof SplitContractInfo)) {
      return super.equals(obj);
    }
    SplitContractInfo other = (SplitContractInfo) obj;
  ...
  public static SplitContractInfo parseFrom(
  ...
  public static SplitContractInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SplitContractInfo parseFrom(
  ...
  public static SplitContractInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SplitContractInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static SplitContractInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SplitContractInfo prototype) {
  ...
  public static final class Builder extends
    ...
    public SplitContractInfo build() {
      SplitContractInfo result = buildPartial();
    ...
    public SplitContractInfo buildPartial() {
      SplitContractInfo result = new SplitContractInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SplitContractInfo) {
        return mergeFrom((SplitContractInfo)other);
      } else {
    ...
    public Builder mergeFrom(SplitContractInfo other) {
      if (other == SplitContractInfo.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      SplitContractInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (SplitContractInfo) e.getUnfinishedMessage();
  ...
  private static final SplitContractInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SplitContractInfo();
  }

  public static SplitContractInfo getDefaultInstance() {
