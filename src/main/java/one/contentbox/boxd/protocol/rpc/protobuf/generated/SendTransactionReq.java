...
public  final class SendTransactionReq extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TransactionProto.internal_static_rpcpb_SendTransactionReq_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TransactionProto.internal_static_rpcpb_SendTransactionReq_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            SendTransactionReq.class, SendTransactionReq.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof SendTransactionReq)) {
      return super.equals(obj);
    }
    SendTransactionReq other = (SendTransactionReq) obj;
  ...
  public static SendTransactionReq parseFrom(
  ...
  public static SendTransactionReq parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SendTransactionReq parseFrom(
  ...
  public static SendTransactionReq parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SendTransactionReq parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static SendTransactionReq parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SendTransactionReq prototype) {
  ...
  public static final class Builder extends
    ...
    public SendTransactionReq getDefaultInstanceForType() {
      return SendTransactionReq.getDefaultInstance();
    }

    public SendTransactionReq build() {
      SendTransactionReq result = buildPartial();
    ...
    public SendTransactionReq buildPartial() {
      SendTransactionReq result = new SendTransactionReq(this);
      if (txBuilder_ == null) {
        result.tx_ = tx_;
      } else {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SendTransactionReq) {
        return mergeFrom((SendTransactionReq)other);
      } else {
    ...
    public Builder mergeFrom(SendTransactionReq other) {
      if (other == SendTransactionReq.getDefaultInstance()) return this;
      if (other.hasTx()) {
        mergeTx(other.getTx());
      }
      onChanged();
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      SendTransactionReq parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (SendTransactionReq) e.getUnfinishedMessage();
  ...
  private static final SendTransactionReq DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SendTransactionReq();
  }

  public static SendTransactionReq getDefaultInstance() {
