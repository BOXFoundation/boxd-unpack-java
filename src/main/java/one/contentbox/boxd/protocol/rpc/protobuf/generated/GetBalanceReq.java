...
public  final class GetBalanceReq extends
  ...
  public boolean equals(final Object obj) {
    ...
    GetBalanceReq other = (GetBalanceReq) obj;
  ...
  public static GetBalanceReq parseFrom(
  ...
  public static GetBalanceReq parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetBalanceReq parseFrom(
  ...
  public static GetBalanceReq parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetBalanceReq parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetBalanceReq parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetBalanceReq prototype) {
  ...
  public static final class Builder extends
    ...
    public GetBalanceReq build() {
      GetBalanceReq result = buildPartial();
    ...
    public GetBalanceReq buildPartial() {
      GetBalanceReq result = new GetBalanceReq(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetBalanceReq) {
        return mergeFrom((GetBalanceReq)other);
      } else {
    ...
    public Builder mergeFrom(GetBalanceReq other) {
      if (other == GetBalanceReq.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetBalanceReq parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetBalanceReq) e.getUnfinishedMessage();
  ...
  private static final GetBalanceReq DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetBalanceReq();
  }
