...
public final class FaucetGrpc {
  ...
  public static final io.grpc.MethodDescriptor<one.contentbox.boxd.proto.ClaimReq,
      one.contentbox.boxd.proto.ClaimResp> METHOD_CLAIM =
      io.grpc.MethodDescriptor.<one.contentbox.boxd.proto.ClaimReq, one.contentbox.boxd.proto.ClaimResp>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "rpcpb.Faucet", "Claim"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              one.contentbox.boxd.proto.ClaimReq.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              one.contentbox.boxd.proto.ClaimResp.getDefaultInstance()))
          .build();
  ...
  public static abstract class FaucetImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void claim(one.contentbox.boxd.proto.ClaimReq request,
        io.grpc.stub.StreamObserver<one.contentbox.boxd.proto.ClaimResp> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                one.contentbox.boxd.proto.ClaimReq,
                one.contentbox.boxd.proto.ClaimResp>(
                  this, METHODID_CLAIM)))
          .build();
    }
  }
  ...
  public static final class FaucetBlockingStub extends io.grpc.stub.AbstractStub<FaucetBlockingStub> {
     ...
     * </pre>
     */
    public one.contentbox.boxd.proto.ClaimResp claim(one.contentbox.boxd.proto.ClaimReq request) {
  ...
  public static final class FaucetFutureStub extends io.grpc.stub.AbstractStub<FaucetFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<one.contentbox.boxd.proto.ClaimResp> claim(
        one.contentbox.boxd.proto.ClaimReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CLAIM:
          serviceImpl.claim((one.contentbox.boxd.proto.ClaimReq) request,
              (io.grpc.stub.StreamObserver<one.contentbox.boxd.proto.ClaimResp>) responseObserver);
          break;
        default:
  ...
  private static final class FaucetDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return one.contentbox.boxd.proto.FaucetProto.getDescriptor();
    }
  }
